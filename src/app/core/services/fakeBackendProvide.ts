...
export class FakeBackendInterceptor implements HttpInterceptor {
  ...
  intercept(req: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    ...
    if (token && req.url.endsWith('/9999') && req.method === 'GET') {
      return of(new HttpResponse({
        status: 200, body: {
          data: {
            "id": 9999,
            ...
            "sections": [
              {
                ...
                "template": `<div class="tableWrapper" *ngIf="formGroup.controls.externalLinks.controls &&formGroup.controls.externalLinks.controls.length && formGroup.controls.externalLinks.controls[0].controls.select.value">
                    ...
                    \t\t\t<p controlpath="" formcontrolname="" contenteditablenode="" menutype="" commentable="" invalid="false" style="" class="set-align-left">{{formGroup.controls.externalLinks.controls[i].controls.select.value}}&nbsp;{{formGroup.controls.externalLinks.controls[i].controls.select.value == 'Other URL'? formGroup.controls.externalLinks.controls[i].controls.label.value : ''}}&nbsp;<a href="{{formGroup.controls.externalLinks.controls[i].controls.link.value}}" title="">{{formGroup.controls.externalLinks.controls[i].controls.link.value}}</a>
                    \t\t</p>
                    \t</li>
                    </ol>
                    </div>`,
              ...
              },
              {
                  ...
                  "components": [
                    {
                      ...
                      "properties": {
                        "autoFocus": "true",
                        "sectionID": "febd07f2-a39f-46af-9511-cf6696f5e264"
                      },
                      "type": "textarea",
                      "input": true,
                      "defaultValue": ""
                ...
                "sections": null,
                "template": `<ng-container *ngIf="formGroup.controls.description.value">
                  <h2 contenteditableNode="false">Treatment sections</h2>
                  <form-field  class="set-align-left" formControlName="description" commentable="false">
                  </form-field >
                  <div class="tableWrapper" *ngIf="formGroup.controls.descriptionSubsections.controls && formGroup.controls.descriptionSubsections.controls.length">
                  \t<div  formArrayName="descriptionSubsections" contenteditableNode="false" >
                  \t\t<div *ngFor="let control of formGroup.controls.descriptionSubsections.controls;let i=index" formGroupName="{{i}}"  contenteditableNode="false" >
                  \t\t\t<h3 style="min-width: 50px;margin-right: 30px" contenteditableNode="false">
                  \t\t\t\t<form-field formControlName="subTitle" contenteditableNode="false"  commentable="false">
                  \t\t\t\t</form-field>
                  \t\t\t</h3>
                  \t\t\t<div>
                  \t\t\t\t<form-field formControlName="subDescription" menuType="fullMenu">
                  \t\t\t\t</form-field>
                  \t\t\t</div>
                  \t\t</div>
                  \t</div>
...
<form-field  class="set-align-left" formControlName="textArea">
            ...
            "template": `<h2 contenteditableNode="false">Taxon</h2>
