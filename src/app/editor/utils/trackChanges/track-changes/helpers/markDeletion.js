...
const markDeletion = (tr, from, to, user, date, group, markId, connectedTo, delMarkAttrs) => {
    const deletionMark = tr.doc.type.schema.marks.deletion.create(delMarkAttrs ? delMarkAttrs : {
        user: user.userId,
