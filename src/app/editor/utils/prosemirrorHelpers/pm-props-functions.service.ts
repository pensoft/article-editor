...
export class PmPropsFunctionsService {

  constructor() { }

  selectWholeCitatMarks = (view: EditorView, anchor: ResolvedPos, head: ResolvedPos) => {
  ...
  handlePaste = (view: EditorView, event: Event, slice: Slice) => {
  ...
  createSelectionBetween = (editorsEditableObj: any, editorId: string) => {
