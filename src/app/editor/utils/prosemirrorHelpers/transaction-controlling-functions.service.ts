...
import { DOMSerializer, Schema , DOMParser, Fragment ,Node, ResolvedPos, Mark } from 'prosemirror-model';
...
export class TransactionControllingFunctionsService {

  constructor() { }

  updateControlsAndFigures = (
    schema: Schema,
    figuresMap: YMap<any>,
    editorContainers: {
      [key: string]: {
  ...
  preventDragDropCutOnNoneditablenodes = (figuresMap: YMap<any>, rerenderFigures: (citats: any) => any, sectionID: string, citatsEditingSubject?: Subject<any>) => {
